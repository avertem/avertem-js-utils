...
module.exports = class Transaction {
    ...
    constructor(key,transactionValue,parent,sourceAccount,targetAcccount) {
        ...
        let Action = asn.define('Action', function() {
            this.seq().obj(
              ...
              this.key('parent').implicit(4).octstr(),
        ...
        this.transactionSignature = key.sign(this.transactionHashValue);
