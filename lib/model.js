    ...
    constructor(jsonData) {
        ...
        let RDFModel = asn.define('RDFModel', function() {
            this.seq().obj(
                ...
                //this.key('rdfDataFormat').implicit(0).seqof(RDFDataFormat)
                this.key('rdfSubjects').implicit(1).seqof(RDFSubject),
                this.key('rdfNtGroups').implicit(2).seqof(RDFNtGroup)
        ...
        if (jsonData.nts) {
            ...
            this.jsonRDFModel.rdfNtGroups.push(jsonRDFNtGroup)
            ...
            jsonData.subjects.forEach((data) => {
                ...
                this.jsonRDFModel.rdfSubjects.push(jsonRDFSubject)
            });
        }
