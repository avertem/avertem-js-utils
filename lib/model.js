    ...
    constructor(jsonData) {
        ...
        let RDFPredicate = asn.define('RDFPredicate', function() {
            this.seq().obj(
                ...
                this.key('rdfObjects').implicit(1).explicit(16).seqof(RDFObject)
            );
        })
        ...
        let RDFSubject = asn.define('RDFSubject', function() {
            this.seq().obj(
                ...
                this.key('rdfPredicates').implicit(1).explicit(16).seqof(RDFPredicate)
            );
        });
        ...
        let RDFNtGroup = asn.define('RDFNtGroup', function() {
            this.seq().obj(
                this.key('version').implicit(0).use(Version),
                this.key('rdfNT').implicit(1).explicit(16).seqof(RDFNT)
            );
        });
        ...
        let RDFModel = asn.define('RDFModel', function() {
            this.seq().obj(
                ...
                this.key('rdfDataFormat').implicit(1).explicit(16).seqof(RDFDataFormat)
              );
        });
